...
def SegmentUNet(conf, input_dir, output_dir, crf):
    ...
    classifier_path = os.path.join("ResUNetDS.onnx")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', default="ResUNetDSonnx", metavar='M', help="ResUNetDSonnx only")
    ...
    assert args.model=="ResUNetDSonnx", "only ResUNetDSonnx is supported at the moment"
    available_models = ["ResUNetonnx",'UNet', 'ResUNet', 'ResUNetDS', 'SegNet', 'DeepLab']
